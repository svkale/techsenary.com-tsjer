...
{
	request(document.getElementsByClassName("gdoc_active_page")[i].getAttribute("data-gdoc-target-url"),"test",document.getElementById(document.getElementsByClassName("gdoc_active_page")[i].parentElement.getAttribute("data-gdoc-target-ele-id")));
}
...
for(var i=0;i<nav_elements.length;i++)
{
	if(nav_elements[i].getAttribute("data-gdoc-target-url"))
	{
		nav_elements[i].addEventListener("click",function()
		{
			request(this.getAttribute("data-gdoc-target-url"),"test",document.getElementById(this.parentElement.getAttribute("data-gdoc-target-ele-id")));
		});
	}
}
